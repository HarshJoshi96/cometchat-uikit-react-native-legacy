...
export const CometChatUsersWithMessages = (props: CometChatUsersWithMessagesInterface) => {
    ...
    // const [showComponent, setShowComponent] = useState(user && user instanceof CometChat.User ? ComponentNames.Messages : ComponentNames.UserList);
    const [showComponent, setShowComponent] = useState(ComponentNames.UserList);
    // const [selectedUser, setSelectedUser] = useState(user && user instanceof CometChat.User ? user : undefined);
