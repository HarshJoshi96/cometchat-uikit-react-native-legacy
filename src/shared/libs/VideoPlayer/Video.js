...
import { StyleSheet, requireNativeComponent, NativeModules, View, Image, Platform, ViewProps, ImageResizeMode, UIManager } from 'react-native';
...
export default class Video extends Component {
  ...
  render() {
    ...
    const RCTVideoInstance = this.getViewManagerConfig('CCRCTVideo');
